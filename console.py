...
# angela = Member("Angela O'Shaughnessy", "14 Smith Street", "07788976224", "angelaO55@gmail.com", False, 895)
...
# spin = ClassType("Spin", "Energetic cycle workout to music.", "Medium", "Low")
...
# booking_2 = Booking(angela, body_balance_am)
